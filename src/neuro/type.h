...
struct Layout {
  ...
  unsigned int mod;  // Can be: NeuroLayoutModNull | NeuroLayoutModMirror | NeuroLayoutModReflectX | NeuroLayoutModReflectY
  Bool followMouse;
...
struct LayoutConf {
  ...
  const unsigned int mod;  // Can be: NeuroLayoutModNull | NeuroLayoutModMirror | NeuroLayoutModReflectX | NeuroLayoutModReflectY
