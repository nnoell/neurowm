...
static const Key key02[] = { { Mod1Mask,             XK_j,      CHAIN(moveFocusCurrClientA, ARG_CSF(nextC))     } };
static const Key key03[] = { { Mod1Mask,             XK_k,      CHAIN(moveFocusCurrClientA, ARG_CSF(prevC))     } };
static const Key key04[] = { { Mod1Mask,             XK_Tab,    CHAIN(moveFocusCurrClientA, ARG_CSF(oldC))      } };
static const Key key05[] = { { Mod1Mask,             XK_m,      CHAIN(moveFocusCurrClientA, ARG_CSF(headC))     } };
...
static const Key key10[] = { { Mod1Mask,             XK_Up,     CHAIN(moveFocusCurrClientA, ARG_CSF(upC))       } };
static const Key key11[] = { { Mod1Mask,             XK_Down,   CHAIN(moveFocusCurrClientA, ARG_CSF(downC))     } };
static const Key key12[] = { { Mod1Mask,             XK_Left,   CHAIN(moveFocusCurrClientA, ARG_CSF(leftC))     } };
static const Key key13[] = { { Mod1Mask,             XK_Right,  CHAIN(moveFocusCurrClientA, ARG_CSF(rightC))    } };
...
static const Key key20[] = { { Mod1Mask,             XK_z,      CHAIN(toggleLayoutModA, ARG_UINT(mirrModL))     } };
static const Key key21[] = { { Mod1Mask,             XK_x,      CHAIN(toggleLayoutModA, ARG_UINT(reflXModL))    } };
static const Key key22[] = { { Mod1Mask,             XK_y,      CHAIN(toggleLayoutModA, ARG_UINT(reflYModL))    } };
...
static const Key key30[] = { { Mod1Mask,             XK_1,      CHAIN(changeToWorkspaceA, ARG_INT(0))           } };
static const Key key31[] = { { Mod1Mask,             XK_2,      CHAIN(changeToWorkspaceA, ARG_INT(1))           } };
static const Key key32[] = { { Mod1Mask,             XK_3,      CHAIN(changeToWorkspaceA, ARG_INT(2))           } };
static const Key key33[] = { { Mod1Mask,             XK_4,      CHAIN(changeToWorkspaceA, ARG_INT(3))           } };
static const Key key34[] = { { Mod1Mask,             XK_5,      CHAIN(changeToWorkspaceA, ARG_INT(4))           } };
static const Key key35[] = { { Mod1Mask,             XK_6,      CHAIN(changeToWorkspaceA, ARG_INT(5))           } };
static const Key key36[] = { { Mod1Mask,             XK_7,      CHAIN(changeToWorkspaceA, ARG_INT(6))           } };
static const Key key37[] = { { Mod1Mask,             XK_8,      CHAIN(changeToWorkspaceA, ARG_INT(7))           } };
static const Key key38[] = { { Mod1Mask,             XK_9,      CHAIN(changeToWorkspaceA, ARG_INT(8))           } };
static const Key key39[] = { { Mod1Mask,             XK_0,      CHAIN(changeToWorkspaceA, ARG_INT(9))           } };
...
static const Key key42[] = { { Mod1Mask|ShiftMask,   XK_Tab,    CHAIN(changeToRelWorkspaceA, ARG_WSF(oldW))     } };
static const Key key43[] = { { Mod1Mask|ShiftMask,   XK_1,      CHAIN(moveClientToWorkspaceA, ARG_INT(0))       } };
static const Key key44[] = { { Mod1Mask|ShiftMask,   XK_2,      CHAIN(moveClientToWorkspaceA, ARG_INT(1))       } };
static const Key key45[] = { { Mod1Mask|ShiftMask,   XK_3,      CHAIN(moveClientToWorkspaceA, ARG_INT(2))       } };
static const Key key46[] = { { Mod1Mask|ShiftMask,   XK_4,      CHAIN(moveClientToWorkspaceA, ARG_INT(3))       } };
static const Key key47[] = { { Mod1Mask|ShiftMask,   XK_5,      CHAIN(moveClientToWorkspaceA, ARG_INT(4))       } };
static const Key key48[] = { { Mod1Mask|ShiftMask,   XK_6,      CHAIN(moveClientToWorkspaceA, ARG_INT(5))       } };
static const Key key49[] = { { Mod1Mask|ShiftMask,   XK_7,      CHAIN(moveClientToWorkspaceA, ARG_INT(6))       } };
static const Key key50[] = { { Mod1Mask|ShiftMask,   XK_8,      CHAIN(moveClientToWorkspaceA, ARG_INT(7))       } };
static const Key key51[] = { { Mod1Mask|ShiftMask,   XK_9,      CHAIN(moveClientToWorkspaceA, ARG_INT(8))       } };
static const Key key52[] = { { Mod1Mask|ShiftMask,   XK_0,      CHAIN(moveClientToWorkspaceA, ARG_INT(9))       } };
static const Key key53[] = { { Mod1Mask|ControlMask, XK_1,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(0)) } };
static const Key key54[] = { { Mod1Mask|ControlMask, XK_2,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(1)) } };
static const Key key55[] = { { Mod1Mask|ControlMask, XK_3,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(2)) } };
static const Key key56[] = { { Mod1Mask|ControlMask, XK_4,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(3)) } };
static const Key key57[] = { { Mod1Mask|ControlMask, XK_5,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(4)) } };
static const Key key58[] = { { Mod1Mask|ControlMask, XK_6,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(5)) } };
static const Key key59[] = { { Mod1Mask|ControlMask, XK_7,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(6)) } };
static const Key key60[] = { { Mod1Mask|ControlMask, XK_8,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(7)) } };
static const Key key61[] = { { Mod1Mask|ControlMask, XK_9,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(8)) } };
static const Key key62[] = { { Mod1Mask|ControlMask, XK_0,      CHAIN(moveClientToWorkspaceFollowA, ARG_INT(9)) } };
