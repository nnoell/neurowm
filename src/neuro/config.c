...
static const Key key01[] = { { Mod1Mask,             XK_c,      { killCliN, NO_ARG }                      } };
static const Key key02[] = { { Mod1Mask,             XK_j,      { moveFocusN, ARG_SCF(nextC) }            } };
static const Key key03[] = { { Mod1Mask,             XK_k,      { moveFocusN, ARG_SCF(prevC) }            } };
static const Key key04[] = { { Mod1Mask,             XK_Tab,    { moveFocusN, ARG_SCF(oldC) }             } };
static const Key key05[] = { { Mod1Mask,             XK_m,      { moveFocusN, ARG_SCF(headC) }            } };
static const Key key06[] = { { Mod1Mask|ShiftMask,   XK_j,      { swapCliN, ARG_SCF(nextC) }              } };
static const Key key07[] = { { Mod1Mask|ShiftMask,   XK_k,      { swapCliN, ARG_SCF(prevC) }              } };
static const Key key08[] = { { Mod1Mask|ShiftMask,   XK_p,      { swapCliN, ARG_SCF(oldC) }               } };
static const Key key09[] = { { Mod1Mask|ShiftMask,   XK_m,      { swapCliN, ARG_SCF(headC) }              } };
static const Key key10[] = { { Mod1Mask,             XK_Up,     { moveFocusN, ARG_SCF(upC) }              } };
static const Key key11[] = { { Mod1Mask,             XK_Down,   { moveFocusN, ARG_SCF(downC) }            } };
static const Key key12[] = { { Mod1Mask,             XK_Left,   { moveFocusN, ARG_SCF(leftC) }            } };
static const Key key13[] = { { Mod1Mask,             XK_Right,  { moveFocusN, ARG_SCF(rightC) }           } };
static const Key key14[] = { { Mod1Mask|ShiftMask,   XK_Up,     { swapCliN, ARG_SCF(upC) }                } };
static const Key key15[] = { { Mod1Mask|ShiftMask,   XK_Down,   { swapCliN, ARG_SCF(downC) }              } };
static const Key key16[] = { { Mod1Mask|ShiftMask,   XK_Left,   { swapCliN, ARG_SCF(leftC) }              } };
static const Key key17[] = { { Mod1Mask|ShiftMask,   XK_Right,  { swapCliN, ARG_SCF(rightC) }             } };
static const Key key18[] = { { Mod1Mask,             XK_space,  { changeLayoutN, ARG_INT(1) }             } };
static const Key key19[] = { { Mod1Mask,             XK_t,      { toggleFreeCliN, ARG_FLF(defFreeR) }     } };
...
static const Key key25[] = { { Mod1Mask|ShiftMask,   XK_f,      { toggleFullScreenCliN, NO_ARG }          } };
static const Key key26[] = { { Mod1Mask,             XK_comma,  { increaseMasterN, ARG_INT(1) }           } };
static const Key key27[] = { { Mod1Mask,             XK_period, { increaseMasterN, ARG_INT(-1) }          } };
static const Key key28[] = { { Mod1Mask,             XK_l,      { resizeMasterN, ARG_FLOAT(1.0f) }        } };
static const Key key29[] = { { Mod1Mask,             XK_h,      { resizeMasterN, ARG_FLOAT(-1.0f) }       } };
...
static const Key key43[] = { { Mod1Mask|ShiftMask,   XK_1,      { moveCliToWorkspaceN, ARG_INT(0) }       } };
static const Key key44[] = { { Mod1Mask|ShiftMask,   XK_2,      { moveCliToWorkspaceN, ARG_INT(1) }       } };
static const Key key45[] = { { Mod1Mask|ShiftMask,   XK_3,      { moveCliToWorkspaceN, ARG_INT(2) }       } };
static const Key key46[] = { { Mod1Mask|ShiftMask,   XK_4,      { moveCliToWorkspaceN, ARG_INT(3) }       } };
static const Key key47[] = { { Mod1Mask|ShiftMask,   XK_5,      { moveCliToWorkspaceN, ARG_INT(4) }       } };
static const Key key48[] = { { Mod1Mask|ShiftMask,   XK_6,      { moveCliToWorkspaceN, ARG_INT(5) }       } };
static const Key key49[] = { { Mod1Mask|ShiftMask,   XK_7,      { moveCliToWorkspaceN, ARG_INT(6) }       } };
static const Key key50[] = { { Mod1Mask|ShiftMask,   XK_8,      { moveCliToWorkspaceN, ARG_INT(7) }       } };
static const Key key51[] = { { Mod1Mask|ShiftMask,   XK_9,      { moveCliToWorkspaceN, ARG_INT(8) }       } };
static const Key key52[] = { { Mod1Mask|ShiftMask,   XK_0,      { moveCliToWorkspaceN, ARG_INT(9) }       } };
...
static const Key key57[] = { { Mod1Mask,             XK_n,      { minimizeCliN, NO_ARG }                  } };
static const Key key58[] = { { Mod1Mask|ShiftMask,   XK_n,      { restoreCliN, NO_ARG }                   } };
...
static const Button button01[] = { { Mod1Mask,           Button1, { freeMovePointerCliN, NO_ARG },       False } };
static const Button button02[] = { { Mod1Mask,           Button2, { toggleFreeCliN, ARG_FLF(defFreeR) }, False } };
static const Button button03[] = { { Mod1Mask,           Button3, { freeResizePointerCliN, NO_ARG },     False } };
static const Button button04[] = { { Mod1Mask|ShiftMask, Button1, { movePointerCliN, NO_ARG },           False } };
static const Button button05[] = { { Mod1Mask|ShiftMask, Button2, { toggleFullScreenPtrCliN, NO_ARG },   False } };
static const Button button06[] = { { Mod1Mask|ShiftMask, Button3, { resizePointerCliN, NO_ARG },         False } };
