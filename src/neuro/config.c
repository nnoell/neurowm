...
static const LayoutConf tile[] = { {
  ...
  {defTallMasterNum, defTallMasterSize, defTallStepSize, WM_NO_ARG}
} };
...
static const LayoutConf grid[] = { {
  ...
  {WM_NO_ARG, WM_NO_ARG, WM_NO_ARG, WM_NO_ARG}
} };
...
static const Key key01[] = { { Mod1Mask,             XK_c,      {killCliN, WM_NO_ARG}                 } };
...
static const Key key25[] = { { Mod1Mask|ShiftMask,   XK_f,      {toggleFullScreenCliN, WM_NO_ARG}     } };
...
static const Key key42[] = { { Mod1Mask|ShiftMask,   XK_Tab,    {changeToLastWorkspaceN, WM_NO_ARG}   } };
...
static const Key key53[] = { { Mod1Mask|ShiftMask,   XK_q,      {quitN, WM_NO_ARG}                    } };
static const Key key54[] = { { Mod1Mask,             XK_q,      {reloadN, WM_NO_ARG}                  } };
static const Key key55[] = { { Mod1Mask,             XK_F2,     {spawnN, {.com = lchrcmd}}            } };
static const Key key56[] = { { Mod1Mask|ShiftMask,   XK_space,  {resetLayoutN, WM_NO_ARG}             } };
static const Key key57[] = { { Mod1Mask,             XK_n,      {minimizeCliN, WM_NO_ARG}             } };
static const Key key58[] = { { Mod1Mask|ShiftMask,   XK_n,      {restoreCliN, WM_NO_ARG}              } };
...
static const Button button01[] = { { Mod1Mask,           Button1, {freeMovePointerCliN, WM_NO_ARG},     False } };
static const Button button02[] = { { Mod1Mask,           Button2, {toggleFreeCliN, {.ff = defFreeR}},   False } };
static const Button button03[] = { { Mod1Mask,           Button3, {freeResizePointerCliN, WM_NO_ARG},   False } };
static const Button button04[] = { { Mod1Mask|ShiftMask, Button1, {movePointerCliN, WM_NO_ARG},         False } };
static const Button button05[] = { { Mod1Mask|ShiftMask, Button2, {toggleFullScreenPtrCliN, WM_NO_ARG}, False } };
static const Button button06[] = { { Mod1Mask|ShiftMask, Button3, {resizePointerCliN, WM_NO_ARG},       False } };
