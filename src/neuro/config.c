...
static const Key key01[] = { { Mod1Mask,             XK_c,      { killClientN, ARG_SCF(selfC) }              } };
static const Key key02[] = { { Mod1Mask,             XK_j,      { moveFocusClientN, ARG_SCF(nextC) }         } };
static const Key key03[] = { { Mod1Mask,             XK_k,      { moveFocusClientN, ARG_SCF(prevC) }         } };
static const Key key04[] = { { Mod1Mask,             XK_Tab,    { moveFocusClientN, ARG_SCF(oldC) }          } };
static const Key key05[] = { { Mod1Mask,             XK_m,      { moveFocusClientN, ARG_SCF(headC) }         } };
static const Key key06[] = { { Mod1Mask|ShiftMask,   XK_j,      { swapClientN, ARG_SCF(nextC) }              } };
static const Key key07[] = { { Mod1Mask|ShiftMask,   XK_k,      { swapClientN, ARG_SCF(prevC) }              } };
static const Key key08[] = { { Mod1Mask|ShiftMask,   XK_p,      { swapClientN, ARG_SCF(oldC) }               } };
static const Key key09[] = { { Mod1Mask|ShiftMask,   XK_m,      { swapClientN, ARG_SCF(headC) }              } };
static const Key key10[] = { { Mod1Mask,             XK_Up,     { moveFocusClientN, ARG_SCF(upC) }           } };
static const Key key11[] = { { Mod1Mask,             XK_Down,   { moveFocusClientN, ARG_SCF(downC) }         } };
static const Key key12[] = { { Mod1Mask,             XK_Left,   { moveFocusClientN, ARG_SCF(leftC) }         } };
static const Key key13[] = { { Mod1Mask,             XK_Right,  { moveFocusClientN, ARG_SCF(rightC) }        } };
static const Key key14[] = { { Mod1Mask|ShiftMask,   XK_Up,     { swapClientN, ARG_SCF(upC) }                } };
static const Key key15[] = { { Mod1Mask|ShiftMask,   XK_Down,   { swapClientN, ARG_SCF(downC) }              } };
static const Key key16[] = { { Mod1Mask|ShiftMask,   XK_Left,   { swapClientN, ARG_SCF(leftC) }              } };
static const Key key17[] = { { Mod1Mask|ShiftMask,   XK_Right,  { swapClientN, ARG_SCF(rightC) }             } };
...
static const Key key25[] = { { Mod1Mask|ShiftMask,   XK_f,      { toggleFullScreenClientN, ARG_SCF(selfC) }  } };
...
static const Key key57[] = { { Mod1Mask,             XK_n,      { minimizeClientN, ARG_SCF(selfC) }          } };
static const Key key58[] = { { Mod1Mask|ShiftMask,   XK_n,      { restoreLastMinimizedClientN, NO_ARG }      } };
...
static const Button button02[] = { { Mod1Mask,           Button2, { toggleFreeCurrClientN, ARG_FLF(defFreeR) }, False } };
