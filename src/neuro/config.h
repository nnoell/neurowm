...
// Defines
#define NEURO_CONFIG_DEFAULT_INIT_ACTION_CHAIN NEURO_CHAIN_NULL(NeuroActionListNothing)
#define NEURO_CONFIG_DEFAULT_STOP_ACTION_CHAIN NEURO_CHAIN_NULL(NeuroActionListNothing)
