...
static const Key key40[] = { { ControlMask|Mod1Mask,  XK_Left,      CHAIN(changeToRelWorkspaceA, ARG_WSF(prevW))    } };
static const Key key41[] = { { ControlMask|Mod1Mask,  XK_Right,     CHAIN(changeToRelWorkspaceA, ARG_WSF(nextW))    } };
