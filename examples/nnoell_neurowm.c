...
static const Key key01[] = { { myModMask,            XK_c,         { killClientN, ARG_SCF(selfC) }              } };
static const Key key02[] = { { myModMask,            XK_j,         { moveFocusClientN, ARG_SCF(nextC) }         } };
static const Key key03[] = { { myModMask,            XK_k,         { moveFocusClientN, ARG_SCF(prevC) }         } };
static const Key key04[] = { { myModMask,            XK_Tab,       { moveFocusClientN, ARG_SCF(oldC) }          } };
static const Key key05[] = { { myModMask,            XK_m,         { moveFocusClientN, ARG_SCF(headC) }         } };
static const Key key06[] = { { myModMask|ShiftMask,  XK_j,         { swapClientN, ARG_SCF(nextC) }              } };
static const Key key07[] = { { myModMask|ShiftMask,  XK_k,         { swapClientN, ARG_SCF(prevC) }              } };
static const Key key08[] = { { myModMask|ShiftMask,  XK_p,         { swapClientN, ARG_SCF(oldC) }               } };
static const Key key09[] = { { myModMask|ShiftMask,  XK_m,         { swapClientN, ARG_SCF(headC) }              } };
static const Key key10[] = { { myModMask,            XK_Up,        { moveFocusClientN, ARG_SCF(upC) }           } };
static const Key key11[] = { { myModMask,            XK_Down,      { moveFocusClientN, ARG_SCF(downC) }         } };
static const Key key12[] = { { myModMask,            XK_Left,      { moveFocusClientN, ARG_SCF(leftC) }         } };
static const Key key13[] = { { myModMask,            XK_Right,     { moveFocusClientN, ARG_SCF(rightC) }        } };
static const Key key14[] = { { myModMask|ShiftMask,  XK_Up,        { swapClientN, ARG_SCF(upC) }                } };
static const Key key15[] = { { myModMask|ShiftMask,  XK_Down,      { swapClientN, ARG_SCF(downC) }              } };
static const Key key16[] = { { myModMask|ShiftMask,  XK_Left,      { swapClientN, ARG_SCF(leftC) }              } };
static const Key key17[] = { { myModMask|ShiftMask,  XK_Right,     { swapClientN, ARG_SCF(rightC) }             } };
...
static const Key key25[] = { { myModMask|ShiftMask,  XK_f,         { toggleFullScreenClientN, ARG_SCF(selfC) }  } };
...
static const Key key57[] = { { myModMask,            XK_n,         { minimizeClientN, ARG_SCF(selfC) }          } };
static const Key key58[] = { { myModMask|ShiftMask,  XK_n,         { restoreLastMinimizedClientN,  NO_ARG }     } };
static const Key key59[] = { { myModMask|ShiftMask,  XK_t,         { freeClientN, ARG_FLF(bigCenterFreeR) }     } };
...
static const Button button00[] = { { noModMask,           Button1, { moveFocusClientN, ARG_SCF(pointerC) },     True  } };
static const Button button01[] = { { myModMask,           Button1, { freeMovePtrClientN, NO_ARG },              False } };
static const Button button02[] = { { myModMask,           Button2, { toggleFreePtrClientN, ARG_FLF(defFreeR) }, False } };
static const Button button03[] = { { myModMask,           Button3, { freeResizePtrClientN, NO_ARG },            False } };
static const Button button04[] = { { myModMask|ShiftMask, Button1, { movePtrClientN, NO_ARG },                  False } };
static const Button button05[] = { { myModMask|ShiftMask, Button2, { toggleFullScreenPtrClientN, NO_ARG },      False } };
static const Button button06[] = { { myModMask|ShiftMask, Button3, { resizePtrClientN, NO_ARG },                False } };
